...
export async function verifyProof(deserialized) {
    try {
        ...
        const verification = wasmFunctions.verify(proof, verification_key, settings, stringToUint8ClampedArray('random_string'));
